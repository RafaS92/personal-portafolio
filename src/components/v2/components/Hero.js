...
function Hero() {
  return (
    <div className='hero-div'>
      <h5 className='bright'>Hello World!</h5>
      <h1 className='title-v2'>I'M RAFAEL VALDEZ</h1>
      <h2 className='subtitle-v2'>Software Engineer</h2>
      <p>
        Reprehenderit velit minim in excepteur irure ut laboris nostrud
        consectetur est ullamco fugiat minim. Id consequat minim exercitation
        Non nulla aliqua Lorem eu consectetur quis cupidatat tempor incididunt
